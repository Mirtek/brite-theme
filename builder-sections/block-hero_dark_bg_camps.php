<section class="camps-hero bg-figures-white">
  <div class="block-container">
    <div class="camps-hero__text">
      <h1 class="camps-hero__heading"><?php echo get_sub_field('heading'); ?></h1>
