  ...
  <div class="block-container">
    ...
    <ul class="top-courses__list">
      ...
      <li class="top-courses__item top-courses__item_circle-5">
        <?php echo brite_sprite_multi('logo-python'); ?>
      </li>
      ...
      <li class="top-courses__item top-courses__item_circle-9">
        <?php echo brite_sprite_multi('logo-unity'); ?>
      </li>
      <li class="top-courses__item top-courses__item_circle-10">
        <?php echo brite_sprite_multi('logo-roblox'); ?>
      </li>
      <li class="top-courses__item top-courses__item_circle-11">
        <?php echo brite_sprite_multi('logo-minecraft'); ?>
      </li>
      <li class="top-courses__item top-courses__item_circle-12">
        <?php echo brite_sprite_multi('logo-js'); ?>
      </li>
    </ul>
    <a class="btn btn_secondary" href="<?php echo get_sub_field('primary_button_url'); ?>"><?php echo get_sub_field('primary_button_text'); ?></a>
  </div>
</section>
