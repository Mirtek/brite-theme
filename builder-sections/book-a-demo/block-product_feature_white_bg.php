...
$data = get_white_bg_secton_icon_n_classes($bg_type);
...
<section class="product-feature <?php echo $data['section_classes']; ?>">
  <div class="block-container">
    <div class="product-feature__content">
      ...
      <button class="btn btn_pink-gradient" <?php echo get_field('onclick_link', 'option'); ?>><?php the_sub_field('primary_button_text'); ?></button>
    </div>
