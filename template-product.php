...
<?php if ( have_rows('builder') ) { ?>
  ...
  while ( have_rows('builder') ) { 
    ...
    if ( get_row_layout() == 'hero_section' ){
      get_template_part( 'builder-sections/book-a-demo/block', 'hero_dark_bg_big' );
    }
    elseif ( get_row_layout() == 'top_courses_big_section' ){
      get_template_part( 'builder-sections/book-a-demo/block', 'top_courses_big_product_page' );
    }
    elseif ( get_row_layout() == 'product_feature_white_background_section' ){
      get_template_part( 'builder-sections/book-a-demo/block', 'product_feature_white_bg' );
    }
    elseif ( get_row_layout() == 'product_feature_dark_background_section' ){
      get_template_part( 'builder-sections/book-a-demo/block', 'product_feature_dark_bg' );
    }
